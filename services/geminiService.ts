...
- 별표 1개 또는 2개는 어떤 경우에도 절대 사용하지 마세요.
  ...
  async getMeditation(type: TabType, bibleText: string): Promise<string> {
    ...
    switch (type) {
      case TabType.OBSERVATION:
        ...
        6. 별표 기호 하나(별) 또는 두 개(볈볈)는 절대 사용하지 마세요.
        7. 항목 시작에 별표 대신 숫자로 번호를 매기세요 (예: 1. 2. 3.)
        `;
        break;
      case TabType.INTERPRETATION:
        ...
        5. 별표 기호 하나(별) 또는 두 개(볈볈)는 절대 사용하지 마세요.
        6. 항목 시작에 별표 대신 숫자로 번호를 매기세요 (예: 1. 2. 3.)
        `;
        break;
